 ...
 */
public class Simulation_Navigator_Behaviour extends Behavior implements KeyListener {
     ...
     */
    public Simulation_Navigator_Behaviour(TransformGroup targetTG) {
	keyNavigator = new Simulation_Navigator(targetTG);
    }
    
    //Constructeur supplementaire 
    //Permet de construire un SNB avec des coordonnees de depart
    public Simulation_Navigator_Behaviour(TransformGroup targetTG, Vector3d init_pos) {
	keyNavigator = new Simulation_Navigator(targetTG, init_pos);
    }
     ...
     * @since Java 3D 1.2.1
     */
    public Simulation_Navigator_Behaviour(Component c, TransformGroup targetTG) {
	this(targetTG);
	if (c != null) {
	    c.addKeyListener(this);
	}
